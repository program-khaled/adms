<h1>    مرحبا <?php echo $_settings->userdata('firstname')." ".$_settings->userdata('lastname') ?></h1>
<hr>
<style>
  #site-cover{
    width:100%;
...
<div class="row">
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">الماركات التجارية</span>
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">انواع السيارات</span>
        <span class="info-box-number text-right h5">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">موديل السيارات</span>
        <span class="info-box-number text-right h5">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">السيارات المتوفرة للبيع</span>
        <span class="info-box-number text-right h5">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">السيارات التي تم بيعها</span>
        <span class="info-box-number text-right h5">
          <?php 
