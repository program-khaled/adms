...
<div class="container-fluid">
    <div class="d-flex w-100">
        <div class="col-3 mb-0 border bg-gradient-secondary">رقم ملف السيارة</div>
...
<div class="py-3 text-right">
    <button class="btn btn-sm btn-flat btn-navy bg-gradient-navy" id="edit-vehicle" type="button"><i class="fa fa-edit"></i> تحرير</button>
    <button class="btn btn-sm btn-flat btn-danger bg-gradient-danger" id="delete-vehicle" type="button"><i class="fa fa-trash"></i> حذف</button>
    <button class="btn btn-sm btn-flat btn-light bg-gradient-light border" data-dismiss="modal" type="button"><i class="fa fa-close"></i> اغلاق</button>
</div>
<script>
	$(function(){
