...
<div class="content py-5 px-3 bg-gradient-navy">
	<h4 class="font-wight-bolder"><?= isset($id) ? "تحديث تفاصيل " : "اضافة سيارة جديدة" ?></h4>
</div>
	...
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
				...
				<div class="container-fluid">
					<form action="" id="model-form">
						...
						<div class="row">
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="car_type_id" class="control-label">نوع السيارة</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="engine_type" class="control-label">نوع المحرك</label>
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="transmission_type" class="control-label">نوع الكير</label>
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<label for="technology" class="control-label">المواصفات</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
									<option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>متوفر</option>
									<option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>غير متوفر</option>
								</select>
							</div>
						</div>
					</form>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-flat btn-sm btn-navy bg-gradient-navy" form="model-form"><i class="fa fa-save"></i> حفظ</button>
				<?php if(isset($id)): ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models/view_model&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-angle-left"></i> الغاء</a>
				<?php else: ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=models"><i class="fa fa-angle-left"></i> الغاء</a>
				<?php endif; ?>
			</div>
		</div>
	</div>
...
<script>
	$(document).ready(function(){
		$('#brand_id').select2({
			placeholder:"الرجاء اختر ماركة السيارة",
			width:'100%',
			containerCssClass:'form-control form-control-sm rounded-0'
		})
		$('#car_type_id').select2({
			placeholder:"الرجاء اختر نوع السيارة",
			width:'100%',
			containerCssClass:'form-control form-control-sm rounded-0'
		})
