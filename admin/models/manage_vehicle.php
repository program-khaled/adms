    ...
    <form action="" id="vehicle-form">
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mv_number" class="control-label">رقم السيارة</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="plate_number" class="control-label">رقم الوحة</label>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="chasis_number" class="control-label">رقم الشاصي</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="variant" class="control-label">الون</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mileage" class="control-label">الامتار</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <input type="number" step="any" name="price" id="price" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($price) ?>"  required/>
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="status" class="control-label">الحالة</label>
                <select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
                    <option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>متوفر </option>
                    <option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>تم البيع</option>
                </select>
            </div>
        </div>
    </form>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						uni_modal('<i class="fa fa-th-list"></i> تفاصيل السيارة', 'models/view_vehicle.php?id='+resp.vid)
