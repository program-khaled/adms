...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=models/manage_model" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  اضف جديد</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="./?page=models/view_model&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> عرض تفاصيل</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item" href="./?page=models/manage_model&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> تحرير</a>
				                    <div class="dropdown-divider"></div>
