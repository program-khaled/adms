...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">تقارير المبيعات الشهرية</h3>
	</div>
	<div class="card-body">
        <div class="container-fluid">
            <fieldset class="border pb-3 px-2 mb-3">
                <legend class="w-auto px-3">ابحث عن مبيعاتك</legend>
                <form action="" id="filter-form">
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="month" class="control-label">اختار الشهر</label>
                                <input type="month" class="form-control form-control-sm rounded-0" id="month" name="month" value="<?= $month ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <button class="btn btn-flat btn-primary bg-gradient-primary btn-sm"><i class="fa fa-filter"></i> بحث</button>
                                <button class="btn btn-flat btn-success bg-gradient-success btn-sm" type="button" id="print"><i class="fa fa-print"></i> طباعة</button>
                            </div>
                        </div>
                    </div>
                </form>
			...
			<table class="table table-hover table-striped table-bordered" id="transaction-tbl">
						...
						<tr>
							...
							<td class="">
								<div style="line-height:1em">
									...
									<div><small class="text-muted">رقم الوحة #: <?= $row['mv_number'] ?></small></div>
								</div>
							</td>
				...
				<tfoot>
					<tr>
						<th colspan="4" class="text-center font-weight-bolder">مجموع المبيعات</th>
	...
	<div>
		...
		<div class="d-flex w-100 align-items-center">
			...
			<div class="col-8 text-center" style="line-height:1em">
				...
				<h4 class="text-center mb-0">تقارير المبيعات الشهرية</h4>
				<h4 class="text-center mb-0">لتاريخ <?= date("F Y", strtotime($month.'-01')) ?> -</h4>
			</div>
		</div>
		<hr>
	</div>
