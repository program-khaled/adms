...
<div class="content py-5 px-3 bg-gradient-navy">
	<h4 class="font-wight-bolder">تفاصيل معاملة بيع سيارة</h4>
</div>
<div class="row mt-n4 align-items-center justify-content-center flex-column">
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-footer py-1 text-center">
				<button class="btn btn-flat btn-sm btn-success bg-gradient-success" id="print"><i class="fa fa-print"></i> طباعة</button>
				<a class="btn btn-flat btn-sm btn-navy bg-gradient-navy border" href="./?page=vehicles/sell_vehicle&transaction_id=<?= isset($transaction['id']) ? $transaction['id'] : '' ?>"><i class="fa fa-edit"></i> تحرير</a>
				<button class="btn btn-flat btn-sm btn-danger bg-gradient-danger" id="delete-transaction"><i class="fa fa-trash"></i> حذف</button>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=vehicles/transactions"><i class="fa fa-angle-left"></i> العودة</a>
			</div>
		</div>
		<div class="card rounded-0 shadow">
			<div class="card-body">
				<div class="container-fluid" id="printout">
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">الماركة</div>
						<div class="col-9 mb-0 border"><?= isset($model['brand']) ? $model['brand'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">نوع السيارة</div>
						<div class="col-9 mb-0 border"><?= isset($model['car_type']) ? $model['car_type'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">الموديل</div>
						<div class="col-9 mb-0 border"><?= isset($model['model']) ? $model['model'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">نوع المحرك</div>
					...
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">المواصفات</div>
