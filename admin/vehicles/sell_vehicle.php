	...
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			...
			<div class="card-body">
				<div class="container-fluid">
					...
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">نوع الكير</div>
		...
		<div class="card rounded-0 shadow">
					...
					<form action="" id="transaction-form">
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="agent_name" class="control-label">اسم المشتري الكامل</label>
						...
						<div class="row">
							...
							<div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<label for="middlename" class="control-label">اسم الاب</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="sex" class="control-label">الجنس</label>
								<select name="sex" id="sex" class="form-control form-control-sm rounded-0" required="required">
									<option value="ذكر" <?= isset($sex) && $sex == 'Male' ? 'selected' : '' ?>>ذكر</option>
									<option value="انثى" <?= isset($sex) && $sex == 'Female' ? 'selected' : '' ?>>انثى</option>
								</select>
							</div>
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="dob" class="control-label">المواليد</label>
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<label for="contact" class="control-label">رقم الهاتف #</label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-flat btn-sm btn-navy bg-gradient-navy" form="transaction-form"><i class="fa fa-save"></i> انجاز معاملة البيع</button>
				<?php if(isset($transaction['id']) && $transaction['id']): ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=vehicles/view_transaction&id=<?= isset($transaction['id']) ? $transaction['id'] : '' ?>"><i class="fa fa-angle-left"></i> الغاء</a>
				<?php else: ?>
				<a class="btn btn-flat btn-sm btn-light bg-gradient-light border" href="./?page=vehicles"><i class="fa fa-angle-left"></i> الغاء</a>
				<?php endif; ?>
			</div>
		</div>
	</div>
